...
/datum/hud/human
	...
	HUDoverlays = list(
		...
		"damageoverlay"  = list("type" = /obj/screen/full_1_tile_overlay, "loc" = "WEST,SOUTH-1 to EAST+1,NORTH", "minloc" = "WEST,SOUTH to EAST,NORTH", "icon_state" = "blank"),
		"glassesoverlay" = list("type" = /obj/screen/glasses_overlay, "loc" = "CENTER-7,CENTER-7", "icon_state" = "blank"),
	)
